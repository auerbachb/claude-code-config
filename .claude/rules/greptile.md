...
If exhausted, perform self-review, report `"Greptile budget exhausted ({used}/{budget}). PR #N falling back to self-review — merge blocked until manual review or budget resets tomorrow."` Self-review does NOT satisfy the merge gate.
