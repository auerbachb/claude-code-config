...
- **Ceiling:** 3-4 active CR-polled PRs max, never over the repo-wide `active_work_cap` (`min()` governs, never raises — `active-work-cap.md`); at 7+ CR reviews/hour expect Greptile fallback. Refill when below — `CLAUDE.md` "KEEP THE PIPELINE FULL".
