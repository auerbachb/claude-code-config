...
- `pr-monitor-and-manage-wake-hotspot-decision.md` — diagnosis and KEEP decision for `pr-monitor-and-manage-wake/SKILL.md` churn (4 merged PRs; PRs #867, #887, #921, #982; Issue #1056); verdict: KEEP; churn driven by scheduling-substrate correctness propagation (#867, #982) and direct business-logic authorship (#887, #921); Step 4a test-pinned by `pmm-wake-step-4a.test.sh` via `<!-- test-anchor -->` anchors; no operative change
