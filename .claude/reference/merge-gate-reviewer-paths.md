...
- Severity-gated: merge-ready when ANY of these hold:
  1. **Clean review:** fresh `greptile-apps[bot]` issue comment whose `Last reviewed commit` footer names HEAD (or, supplementally, carries a 👍) AND zero inline diff comments.
