...
4. **Switch CodeRabbit from monthly to annual billing** — same 3 seats, $90 → $72/month, $216/year, no capability change. **Recommended: take it.** This lever waited on the OSS-vs-paid verdict, because prepaying a year of seats would have locked in an answer nobody had checked. That verdict is now recorded — [#1212](https://github.com/auerbachb/claude-code-config/issues/1212) evaluated the free OSS tier and **declined it**: under 10 stars the rate becomes a popularity-scaled 1–10/hr band (this repo has 3), auto-review stops, and the metered add-on in item 9 becomes permanently unavailable. Staying paid is settled, so the only remaining question was cadence, and annual wins it. Math and sourcing: [`cr-oss-vs-paid-decision.md`](./cr-oss-vs-paid-decision.md). Renewal is **2026-08-27**.
