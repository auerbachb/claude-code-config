...
When a subject holds more than one marker — `fix(#749): repair thing (#750)` — the **last** one is the PR; earlier ones are issue references. Getting this backwards silently attributes churn to issue numbers.
