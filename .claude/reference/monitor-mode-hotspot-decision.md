...
The hotspot detector recorded nine merged PRs touching `monitor-mode.md` since 2026-07-20: PRs
#660, #717, #742, #774, #804, #807, #828, #862, and #982. At diagnosis time the file was 65 lines
...
- PM state remains a cache reconciled against GitHub and handoffs; per-skill polling state remains
  owned by the skill that created it.
