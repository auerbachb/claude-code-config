...
| `merge-gate.sh <pr_number> [--reviewer cr\|bugbot\|greptile]` | Verify the merge gate per `.claude/rules/cr-merge-gate.md` (CR path includes CodeAnt when it participated; BugBot / Greptile paths; CI; BEHIND). Prints JSON. Exits `0` met, `1` not met, `2` usage, `3` PR not found, `4` gh error. |
